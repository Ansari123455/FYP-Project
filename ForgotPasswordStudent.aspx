<%@ Page Title="FYP Portal| Student Forgot Password" Language="C#" MasterPageFile="~/ViewReports.master" AutoEventWireup="true" CodeFile="ForgotPasswordStudent.aspx.cs" Inherits="ForgotPasswordStudent" %>
   ...
   <ContentTemplate>
    ...
    <div style="margin-left:20px;">
        ...
        Display="Dynamic" ForeColor="Red" ErrorMessage="* Please Enter Email ID!"></asp:RequiredFieldValidator>
            ...
            <br />
            <asp:Label ID="Label22" runat="server" width="200px" Height="20px" ForeColor="red" Font-Size="Smaller" Text="Example: aminrpk4@gmail.com"></asp:Label>
    </div>
    <br />
    <div align="center">
